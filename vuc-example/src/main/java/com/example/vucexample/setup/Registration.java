...
public class Registration {
    ...
    public static final RegistryObject<Block> SYED_ORE = BLOCKS.register("syed_ore", () -> new Block(ORE_PROPERTIES));
    public static final RegistryObject<Item> SYED_ORE_ITEM = fromBlock(SYED_ORE);
